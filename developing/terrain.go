...
func configureTerrain() {
	splatmap := gravitygl.NewTextureFromFile(gravitygl.TEXTURE_2D, "assets/terr/splatmap.png")
	heightmap := gravitygl.NewTextureFromFile(gravitygl.TEXTURE_2D, "assets/terr/height.png")
	dirt := gravitygl.NewTextureFromFile(gravitygl.TEXTURE_2D, "../assets/textures/terrain/dirt05.jpg")
	rock := gravitygl.NewTextureFromFile(gravitygl.TEXTURE_2D, "../assets/textures/terrain/rock.jpg")
	grass := gravitygl.NewTextureFromFile(gravitygl.TEXTURE_2D, "../assets/textures/terrain/grass.jpg")
